      ...
      <Card className="rounded-2xl border-white/80 bg-white/90 shadow-sm">
        <CardContent className="space-y-6 p-6">
          ...
          <div>
            ...
            <div className="mt-1 font-medium text-stone-800">{formatUtc8DateTime(backupState?.last_started_at, { seconds: false })}</div>
          </div>
          <div>
            <div className="text-xs text-stone-500">最近完成</div>
            <div className="mt-1 font-medium text-stone-800">{formatUtc8DateTime(backupState?.last_finished_at, { seconds: false })}</div>
          </div>
          <div>
                  ...
                  <div key={item.key} className="flex flex-col gap-3 rounded-xl border border-stone-200 bg-white px-4 py-4 md:flex-row md:items-center md:justify-between">
                    <div className="min-w-0 space-y-2">
                      ...
                      <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-stone-500">
                        ...
                        <span>更新时间 {formatUtc8DateTime(item.updated_at, { seconds: false })}</span>
              ...
              <>
                <div className="grid gap-3 rounded-xl border border-stone-200 bg-stone-50 px-4 py-4 text-sm text-stone-600 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <div className="mt-1 font-medium text-stone-800">{formatUtc8DateTime(detail.created_at, { seconds: false })}</div>
                  </div>
                  <div>
